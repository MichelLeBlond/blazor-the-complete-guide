    ...
    public class RoomOrderController : Controller
        ...
        public async Task<IActionResult> PaymentSuccessful([FromBody] RoomOrderDetailsDTO details)
        {
            ...
            if (sessionDetails.PaymentStatus == "paid")
            {
                ...
                await _emailSender.SendEmailAsync(details.Email, "Booking Confirmed - Hidden Villa", "Your booking has been confirmed at Hidden Villa with order ID:" +details.Id);
                return Ok(result);
            }
            else
            {
